...
class MacOSSecureCredential:
    """Secure credential implementation for macOS."""
    ...
    def __enter__(self) -> "MacOSSecureCredential":
...
class KeychainStore(CredentialStore):
    """Credential store implementation using macOS Keychain."""

    def __init__(self):
        """Initialize the store."""
        self._metadata_dir = os.path.expanduser(
            "~/Library/Application Support/Perihelion/Credentials"
        )
